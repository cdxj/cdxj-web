<template>
    <ir-tabs  :navs="navs" @navChange='change'  navBgColor='#ff570a'  :multiple="true">
				...
				>
					...
					>
						<navigator class="item" hover-class="none" :url="'/pages/details/details?id=' + item.docid">
							...
							<view>
								<view class="info">
									<view class="price" style="margin-top: 30px;margin-left: 80px;"><u-icon  @click="collect(item,index)" name="star-fill" color="red" size="48"></u-icon></view>
