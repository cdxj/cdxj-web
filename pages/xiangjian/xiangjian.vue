...
import { mapState, mapMutations } from 'vuex';
 ...
 <style lang="scss">
.select{padding: 0; width: 50px;}
.uni-select__input-text {font-size: 4px !important;}
.uni-select__selector-item {width:20px !important}
/deep/.uni-select__input-text{width:100%;}
